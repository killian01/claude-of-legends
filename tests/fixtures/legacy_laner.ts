// FROZEN FIXTURE: the scripted Laner exactly as it shipped before ADR 0013, kept
// so tests/playbook.test.ts can pin the playbook Laner to it tick for tick.
// Never edit; the day the playbook Laner deliberately diverges, delete both.
//
...
import { effectiveItemCost } from '../../src/sim/content/items';
import { GAME_MAP } from '../../src/sim/content/map';
import type { Action, Observation, ObsSelf, ObsUnit, Policy } from '../../src/sim/policy';
...
export const LEGACY_LANER: BotDef = {
  id: 'laner',
  name: 'Laner',
  policy,
};
