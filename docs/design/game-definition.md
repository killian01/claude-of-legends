...
- **Matchmaking**: one queue; a "play now with bots" button; private lobbies joinable by code; bots backfill empty seats by role (the fill, `CONTEXT.md`).
...
- **Objectives** (ADR 0022, `docs/plan-rings.md`): three neutral creatures on an announced clock. The Pyrefang on the bot ring at 4:00 and the Voidmaul on the top ring at 6:30, each back four minutes after its death, sized for a duo, carrying a fixed order of aspects (Might, Tide, Tempo; Bulwark, Swiftness, Resolve): its death hands the killing team the aspect as a permanent favor and 150 gold to every member. The Warden at the center last, at 12:00 and every 2:30 after: the Boon, temporary and bigger. The camps in the forests pay gold and a personal attack speed buff.
