...
- **Map**: 2 towers per lane plus 2 Sanctum towers; no inhibitors (win condition: destroy the Sanctum towers, then the Sanctum); jungle terrain with brush between lanes, no camps in v1.
