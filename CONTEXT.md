...
must clear the same validation a hand-written kit does, and is pushed to spend the power
budget rather than tiptoe under it. The thread is session-lived; nothing is stored
unreviewed. Drafts only: a sealed kit is locked.
