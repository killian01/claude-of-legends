...
splash art. It lands in the draft for the creator to review, tweak, and save; nothing is
stored unreviewed, and a suggestion must clear the same validation a hand-written kit
does. Drafts only: a sealed kit is locked.
_Avoid_: AI kit, autogenerated champion
